...
namespace SaltEmployeeCalendar\Providers;

use Illuminate\Support\ServiceProvider;

class SaltLaravelEmployeeCalendarServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-employee-calendar');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-employee-calendar');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/salt-laravel-employee-calendar'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'salt-laravel-employee-calendar');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/salt-laravel-employee-calendar'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \SaltEmployeeCalendar\Console\Commands\SaltLaravelEmployeeCalendarCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/salt-laravel-employee-calendar'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/salt-laravel-employee-calendar.php', 'salt-laravel-employee-calendar'
        // );
    }
}
